...
public class CommonSetConfigurationRequestMessageProcessor extends WebServiceRequestMessageProcessor {
    ...
    public void processMessage(final ObjectMessage message) {
        ...
        try {
            ...
            this.configurationManagementService.setConfiguration(messageData.getOrganisationIdentification(),
                    messageData.getDeviceIdentification(), messageData.getCorrelationUid(), configuration,
