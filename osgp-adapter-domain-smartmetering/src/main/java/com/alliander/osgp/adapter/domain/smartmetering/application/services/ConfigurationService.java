...
public class ConfigurationService {
    ...
    public void requestSpecialDays(@Identification final String organisationIdentification,
            @Identification final String deviceIdentification, final String correlationUid,
            final SpecialDaysRequest specialDaysRequestValueObject, final String messageType)
    ...
    public void setConfigurationObject(@Identification final String organisationIdentification,
            @Identification final String deviceIdentification, final String correlationUid,
            final SetConfigurationObjectRequest setConfigurationObjectRequestValueObject, final String messageType)
                    throws FunctionalException {
    ...
    public void replaceKeys(@Identification final String organisationIdentification,
        ...
        final com.alliander.osgp.dto.valueobjects.smartmetering.KeySetDto keySetDto = this.configurationMapper.map(
                keySet, com.alliander.osgp.dto.valueobjects.smartmetering.KeySetDto.class);
